...
button_DA, button_DE, button_DI, button_DO, button_DU, button_D = st.columns(6) 
...
button_GA, button_GE, button_GI, button_GO, button_GU, button_G = st.columns(6)
...
button_HA, button_HE, button_HI, button_HO, button_HU, button_H = st.columns(6)
...
button_LA, button_LE, button_LI, button_LO, button_LU, button_L = st.columns(6)
...
button_MA, button_ME, button_MI, button_MO, button_MU, button_M = st.columns(6)
...
button_NA, button_NE, button_NI, button_NO, button_NU, button_N = st.columns(6)
...
button_NGA, button_NGE, button_NGI, button_NGO, button_NGU, button_NG = st.columns(6)
...
button_PA, button_PE, button_PI, button_PO, button_PU, button_P = st.columns(6)
...
button_RA, button_RE, button_RI, button_RO, button_RU, button_R = st.columns(6)
...
button_SA, button_SE, button_SI, button_SO, button_SU, button_S = st.columns(6)
...
button_TA, button_TE, button_TI, button_TO, button_TU, button_T = st.columns(6)
...
button_WA, button_WE, button_WI, button_WO, button_WU, button_W = st.columns(6)
...
button_YA, button_YE, button_YI, button_YO, button_YU, button_Y = st.columns(6)
